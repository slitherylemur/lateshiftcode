...
- `.github/workflows/deploy-slither-cloud.yml` deploys the `main` branch to the `t3cloud` production checkout and restarts the hosted T3 UI service after successful merges.
